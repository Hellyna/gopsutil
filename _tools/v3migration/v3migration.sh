...
# usage: cd ${GOPATH}/src/github.com/Hellyna/gopsutil && bash tools/v3migration/v3migration.sh
...
###  change import path
find . -name "*.go" -print0 | xargs -0 -I@ sed -i 's|"github.com/Hellyna/gopsutil/|"github.com/Hellyna/gopsutil/v3/|g' @
...
sed -i "/github.com\/Hellyna\/gopsutil\/v3\/net/d" process/process_bsd.go
