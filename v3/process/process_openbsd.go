...
import (
	...
	cpu "github.com/Hellyna/gopsutil/v3/cpu"
	"github.com/Hellyna/gopsutil/v3/internal/common"
	mem "github.com/Hellyna/gopsutil/v3/mem"
	net "github.com/Hellyna/gopsutil/v3/net"
...
func (p *Process) ForegroundWithContext(ctx context.Context) (bool, error) {
	// see https://github.com/Hellyna/gopsutil/issues/596#issuecomment-432707831 for implementation details
	pid := p.Pid
